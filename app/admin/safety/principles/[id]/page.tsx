...
import SafetyPrincipleEditForm from "./SafetyPrincipleEditForm";
...
export default async function EditSafetyPrinciplePage({
  params,
}: PageProps) {
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 rounded-2xl bg-white p-8 shadow-sm">
          <div className="mb-8">
            ...
            <p className="mt-2 text-slate-600">
              Update this safety principle.
            </p>
          </div>

          <SafetyPrincipleEditForm principle={principle} />
        </div>
      </div>
    </main>
  );
